...
### Accessing Services
- **OpsDesk Web UI**: [http://localhost:8080](http://localhost:8080)
- **FastAPI OpenAPI Swagger**: [http://localhost:8080/docs](http://localhost:8080/docs)
- **FastAPI Direct Backend**: [http://localhost:8000](http://localhost:8000)
